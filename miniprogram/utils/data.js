...
// 水域列表（用于选择器）
const WATER_LIST = [
  { id: 'pacific', name: '太平洋', type: '海域', emoji: '🌊' },
  { id: 'atlantic', name: '大西洋', type: '海域', emoji: '🌊' },
  { id: 'indian', name: '印度洋', type: '海域', emoji: '🌊' },
  { id: 'arctic', name: '北冰洋', type: '海域', emoji: '🧊' },
  { id: 'baikal', name: '贝加尔湖', type: '湖泊', emoji: '🏞️' },
  { id: 'ness', name: '尼斯湖', type: '湖泊', emoji: '🏞️' },
  { id: 'xihu', name: '西湖', type: '湖泊', emoji: '🏞️' },
  { id: 'xiang', name: '湘江', type: '河流', emoji: '💧' },
  { id: 'mariana', name: '马里亚纳海沟', type: '海沟', emoji: '深渊' },
  { id: 'deadsea', name: '死海', type: '湖泊', emoji: '🧂' },
  { id: 'aegean', name: '爱琴海', type: '海域', emoji: '🌊' },
  { id: 'galapagos', name: '加拉帕戈斯', type: '海域', emoji: '🐢' }
];
...
// 回信时间选项
const FB_OPTIONS = [
  { value: '24h', label: '24 小时后', ms: 24 * 3600 * 1000 },
  { value: '3d', label: '3 天后', ms: 3 * 24 * 3600 * 1000 },
  { value: '7d', label: '7 天后', ms: 7 * 24 * 3600 * 1000 },
  { value: 'custom', label: '自选时间', ms: 0 }
];
